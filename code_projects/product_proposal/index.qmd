...
Below are key snippets of code I developed during the data analysis phase, which played a critical role in shaping our product’s direction. I led this part of the project, as it closely aligned with my strengths. I used a preliminary dataset to inform our pricing strategy and another (UberDataset) to identify market gaps and opportunities. Snippets from the latter dataset are included below to illustrate how it supported our decision-making process.
::: 
